...
6. Write an application to **read and write data from EEPROM memory using I2C in RPi** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task6)
7. Write an application to **send and receive data via UART to a PC terminal** (e.g., Tera Term, PuTTY, Minicom) for RPi ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task7)
8. Write an application to **use MPU6050 or LSM6DS3 to get motion and tilt data in RPi** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task8)
...
9. Write a program to interface **LED with GPIO** of STM32 microcontroller ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task9)
10. Write an application to create **LED chaser (alternate LEDs should glow)** using STM32 microcontroller ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task10)
11. Write an application code for STM32 microcontroller to **control LED intensity using PWM** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task11)
12. Write an application code to **interface Push Button and LED in polling method** for STM32 microcontroller ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task12)
13. Write an application to **interface STM32 microcontroller I2C/SPI-based sensors like BMP280** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task13)
14. Write an application to **read and write data from EEPROM memory using I2C** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task14)
15. Write an application to **send and receive data via UART to a PC terminal** (e.g., Tera Term, PuTTY, Minicom) ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task15)
16. Write an application to **use MPU6050 or LSM6DS3 to get motion and tilt data** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task16)
...
17. Write an application to **read potentiometer values via ADC** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task17)
18. Write an application code to **measure power supply voltage via ADC** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task18)
19. Write an application to **implement STOP and STANDBY modes for power optimization** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task19)
20. Write an application to **enable hardware interrupt for controlling output** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task20)
21. Write an application to **control multiple LEDs with different ON/OFF intervals without using delay()** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task21)
22. Write an application to **implement software or hardware debouncing for a button-controlled LED** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task22)
23. Write an application to **modify the delay to make the LED blink faster (e.g., 100ms ON/OFF) using a timer** ✅  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task23)
24. Write an application to **change LED color based on temperature sensor readings and trigger a buzzer interrupt** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task24)
25. Write an application to **control the LED remotely via STM32 using BLE** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task25)
26. Write an application to **implement a traffic light sequence using Red, Yellow, and Green LEDs for STM32F401RE** ❌  
   🔗 [View Code](./BareMetal_&_HAL_Lib_Tasks/Task26)
...
1. Write an application to **create multiple FreeRTOS tasks to blink LEDs at different rates** ✅  
   🔗 [View Code](./RTOS_Tasks/Task1)  
2. Write an application to **use a button press to trigger an LED toggle via a binary semaphore** ✅  
   🔗 [View Code](./RTOS_Tasks/Task2)  
3. Write an application to **implement round-robin scheduling with equal priority tasks** ✅  
   🔗 [View Code](./RTOS_Tasks/Task3)  
...
7. Write an application to **create software timers for periodic tasks (sensor reading, logging)** ✅  
   🔗 [View Code](./RTOS_Tasks/Task7)
8. Write an application to **dynamically create and delete tasks based on system requirements** ✅  
   🔗 [View Code](./RTOS_Tasks/Task8)
9. Write an application to **implement low-power mode using the FreeRTOS idle task hook** ✅  
   🔗 [View Code](./RTOS_Tasks/Task9)
10. Write an application to **read multiple sensors at different rates and store data using scheduled tasks** ✅  
   🔗 [View Code](./RTOS_Tasks/Task10)
11. Write an application to **use FreeRTOS event groups to synchronize multiple tasks** ✅  
   🔗 [View Code](./RTOS_Tasks/Task11)
12. Write an application to **implement UART communication with concurrent task access** ✅  
   🔗 [View Code](./RTOS_Tasks/Task12)
13. Write an application to **use an external interrupt to wake up a FreeRTOS task** ✅  
   🔗 [View Code](./RTOS_Tasks/Task13)
14. Write an application to **implement Producer-Consumer model using queues** ✅  
   🔗 [View Code](./RTOS_Tasks/Task14)
15. Write an application to **demonstrate priority inversion using high and low priority tasks** ✅  
   🔗 [View Code](./RTOS_Tasks/Task15)
...
1. Write an application to **demonstrate ADC-based button inputs available on the board** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task1)
2. Write an application to **implement BLE beacon broadcasting** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task2)
3. Write an application to **control LED blinking via BLE using a smartphone** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task3)
4. Write an application to **host a Wi-Fi web server to control LED blinking** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task4)
5. Write an application to **run Wi-Fi and BLE simultaneously on the ESP32** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task5)
6. Write an application to **generate a beep sound using the audio jack output** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task6)
7. Write an application to **demonstrate the onboard microphone functionality** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/Platformio_Tasks/Task7)
...
1. Write an application to **blink an LED using the ESP-IDF framework** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/ESP-IDF_Tasks/Task1)
2. Write an application to **demonstrate FreeRTOS mutex usage in ESP-IDF** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/ESP-IDF_Tasks/Task2)
3. Write an application to **demonstrate FreeRTOS semaphore mechanisms in ESP-IDF** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/ESP-IDF_Tasks/Task3)
4. Write an application to **implement inter-task communication using FreeRTOS queues** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/ESP-IDF_Tasks/Task4)
5. Write an application to **demonstrate task prioritization using UART logs in FreeRTOS** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/ESP-IDF_Tasks/Task5)
6. Write an application to **demonstrate the onboard microphone functionality** ✅  
   🔗 [View Code](./ESP32_Lyrat_Tasks/ESP-IDF_Tasks/Task6)